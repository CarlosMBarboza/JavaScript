class Persona{// Esto es la clase padre 
    ...
    los atributos Static  se asician con nuetra plantilla, con nuetra clase */
        static contadorPersona = 0;// atributos de clas
        static get MAX_OBJ(){
            return 3;
        }
        constructor(nombre, apellido){// Esto es un metodo 
            ...
            this.idPersona = ++Persona.contadorPersona;// Le asignamos un id caves que creamos una persona
                ...
                console.log('Se supero el limite Permitido');
            }
        }
    ...
    let persona2 = new Persona('Carl', 'oza');
    let persona3 = new Persona('Carlos', 'Barboza');